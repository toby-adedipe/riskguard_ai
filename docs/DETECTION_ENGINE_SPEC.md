...
> **Status (2026-07-09): Phase 0A foundation implemented.** Canonical replay,
> prior-sample median/MAD fallback, KPI polarity, stable evidence, and
> transparent LGA risk aggregation are real. Seasonal baselines, gap/skew
> handling, shape classification, spatial correlation, time-to-breach, and the
> incident lifecycle below remain to be implemented.
